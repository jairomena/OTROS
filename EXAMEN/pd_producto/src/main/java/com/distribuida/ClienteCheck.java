...
@ApplicationScoped
@Liveness
public class ClienteCheck implements HealthCheck {

    private static final String SERVICE_URL = System.getenv("CLIENT_URL") + "/clients";
    ...
    private boolean isServiceRunning() {
        try {
            URL serviceUrl = new URL(ClienteCheck.SERVICE_URL);
